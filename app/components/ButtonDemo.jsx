...
export default class ButtonDemo extends Component {
    ...
    render () {
        const renderButtons = this.props.colors.map((color, i) => {
            const renderIcon = (this.props.icons === undefined || this.props.icons.length === 0)
                ? null : this.props.sizes[i];
            const renderSize = (this.props.sizes === undefined || this.props.sizes.length === 0)
                ? null : this.props.sizes[i];
